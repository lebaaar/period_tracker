...
class ApplicationDataService {
  ...
  /// Checks if the provided JSON data was generated by this app by checking package name identifier under 'app'
  /// @param data The Map representation of the JSON backup data file
  /// @returns true if the JSON data was generated by this app, false otherwise
  bool isJsonFromPeriodTracker(Map<String, dynamic> data) {
    try {
      if (data.containsKey('app')) {
        final appIdentifier = data['app'];
        return appIdentifier == kPackageName;
      }
      return false;
    } catch (e) {
      return false;
